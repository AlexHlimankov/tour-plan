        ...
        <ul class="footer__ul">
          <li class="footer__item footer__item--mb-2">
            <div class="footer__icon-wrapper">
              <img src="/img/map-marker.svg" class="footer__icon" alt="Icon: map">
            </div>
          ...
          <li class="footer__item footer__item--mb-2">
            <div class="footer__icon-wrapper">
              <img src="/img/phone-call.svg" class="footer__icon" alt="Icon: call">
            </div>
          ...
          <li class="footer__item footer__item--mb-2">
            <div class="footer__icon-wrapper">
              <img src="/img/email.svg" class="footer__icon" alt="Icon: email">
            </div>
...
<div class="modal" id="booking-modal">
  ...
  <div class="modal__dialog">
    ...
    <h3 class="modal__title modal__title--mb3">Send us a message</h3>
